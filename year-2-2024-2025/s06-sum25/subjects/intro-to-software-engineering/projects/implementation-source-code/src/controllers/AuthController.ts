...
// AuthController - Xá»­ lĂ½ logic Ä‘iá»u khiá»ƒn authentication
...
export class AuthController {
  ...
  // Kiá»ƒm tra tráº¡ng thĂ¡i Ä‘Äƒng nháº­p
  static isLoggedIn(): boolean {
    return this.currentUser !== null;
  }

  // Láº¥y thĂ´ng tin user hiá»‡n táº¡i
  ...
  // Khá»Ÿi táº¡o authentication state
