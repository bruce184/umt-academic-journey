...
const seedData = async () => {
  try {
    ...
    console.log('đŸŒ± Starting to seed data...');
    ...
    // Insert semesters
    console.log('đŸ“… Inserting semesters...');
    await pool.request()
    ...
    // Insert courses
    console.log('đŸ“ Inserting courses...');
    const courses = [
    ...
    console.log('đŸ‘¥ Inserting users...');
    const users = [
      // Admin
    ...
    // Insert classes
    console.log('đŸ« Inserting classes...');
    const classes = [
    ...
    // Insert schedules
    console.log('đŸ“… Inserting schedules...');
    const schedules = [
    ...
    console.log('đŸ‘¨â€đŸ« Inserting class instructors...');
    const instructors = [
    ...
    // Insert enrollments
    console.log('đŸ“ Inserting enrollments...');
    const enrollments = [
    ...
    console.log('đŸ“ Updating enrollment counts...');
    ...
    // Insert assignments
    console.log('đŸ“‹ Inserting assignments...');
    const assignments = [
    ...
    console.log('đŸ“¢ Inserting announcements...');
    const announcements = [
    ...
    console.log('đŸ’° Inserting tuition payments...');
    const payments = [
    ...
    console.log('\nđŸ“‹ Test Accounts:');
    console.log('đŸ‘¨â€đŸ’¼ Admin: admin / demo-password');
    console.log('đŸ‘¨â€đŸ« Lecturer: dr.smith / demo-password');
    console.log('đŸ‘¨â€đŸ“ Student: student1 / demo-password');
