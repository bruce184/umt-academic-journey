...
// LoginView - Giao diá»‡n Ä‘Äƒng nháº­p (View trong MVC)
const LoginView: React.FC = () => {
  ...
  const handleDemoLogin = (role: 'student' | 'lecturer' | 'admin') => {
    const demoCredentials = {
      student: { username: 'student1', password: 'demo-password' },
      lecturer: { username: 'dr.smith', password: 'demo-password' },
      admin: { username: 'admin', password: 'demo-password' }
    };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            Â© 2024 OCMS. All rights reserved.
          </p>
        </div>
      </div>
    </div>
